...
// LIBDPSLR INCLUDES
// =====================================================================================================================
#include <LibDPSLR/ILRSFormats/cpf/records/cpf_data.h>
...
std::string CPFData::PositionRecord::generateLine(float) const
{
    ...
    line_10 << DataIdStr[static_cast<int>(DataRecordType::POSITION_RECORD)]
            ...
            << ' ' << this->leap_second
            << ' ' << helpers::strings::numberToStr(this->geocentric_pos[0], 17, 3)
            << ' ' << helpers::strings::numberToStr(this->geocentric_pos[1], 17, 3)
            << ' ' << helpers::strings::numberToStr(this->geocentric_pos[2], 17, 3);
    // Return the line.
    return line_10.str();
}
