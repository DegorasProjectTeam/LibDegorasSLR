...
public:
    ...
    /// @enum PredictionMode
    /// This enum represents the different calculation modes.
     ...
     */
    PredictionError predict(unsigned mjd, long double second, PredictionResult& interp_res) const;
     ...
     * @return the error code generated by the interpolation.
     */
    PredictionError predict(long double mjt, PredictionResult& interp_res) const;
