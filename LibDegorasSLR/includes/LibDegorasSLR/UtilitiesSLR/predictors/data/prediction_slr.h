...
struct LIBDPSLR_EXPORT PredictionSLR
{
    ...
    InstantRange instant_range;           ///< Result range for the instant time, always available if PREDICTION_OK.
    ...
    // Error code.
    ErrorType error;   ///< Error that may have occurred (zero is always PREDICTION_OK).
