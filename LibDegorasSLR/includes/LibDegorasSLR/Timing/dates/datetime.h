...
private:
    ...
    types::DayFraction fract_;  ///< Decimal fraction of that day (up to nanoseconds resolution in day fraction sense).
    types::SoD sod_;            ///< Number of seconds in that day (up to picoseconds resolution).
};
...
/// Alias for a vector of DateType objects.
...
// TEMPLATES INCLUDES
// =====================================================================================================================
#include <LibDegorasSLR/Timing/dates/datetime.tpp>
// =====================================================================================================================
