...
LIBDPSLR_EXPORT types::Iso8601Str modifiedJulianDateTimeToIso8601(const dates::MJDateTime& mjdt,
                                        types::TimeResolution resolution = types::TimeResolution::MILLISECONDS,
                                        bool utc = true, bool rm_trailing_zeros = true);
 ...
 */
LIBDPSLR_EXPORT dates::JDateTime timePointToJulianDateTime(const types::HRTimePointStd &tp);
...
LIBDPSLR_EXPORT types::HRTimePointStd julianDateTimeToTimePoint(const dates::JDateTime& jdt);
// =====================================================================================================================
 ...
 */
LIBDPSLR_EXPORT types::HRTimePointStd dateAndTimeToTp(int y, int m, int d, int h=0, int min=0, int s=0);
