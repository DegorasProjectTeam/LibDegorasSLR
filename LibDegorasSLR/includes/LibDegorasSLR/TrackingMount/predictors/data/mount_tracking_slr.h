...
struct MountTrackingSLR
{
    ...
    PredictionMountSLRV predictions;         ///< Predicted data for the required time interval.

    // Predictors.
    slr::predictors::PredictorSlrPtr predictor_slr;    ///< Internal PredictorSLR predictor.
