...
public:
    ...
    struct LIBDPSLR_EXPORT InstantRange
    {
        ...
        // Datetime members.
        MJDType mjd;                  ///< Modified julian date in days.
        SoDType sod;               ///< Second of day in that MJD (ps precission -> 12 decimals).
        MJDtType mjdt;              ///< Modified julian datetime (day & fraction -> 12 decimals).
     ...
     */
    PredictionError predict(MJDType mjd, SoDType second, PredictionResult& result) const;
     ...
     * @return The error code generated by the predictor.
     */
    PredictionError predict(MJDtType mjdt, PredictionResult& result) const;
