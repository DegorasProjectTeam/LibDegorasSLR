 ...
 */
    ...
    result.error = static_cast<PredictionSLR::ErrorType>(PredictionError::PREDICTION_OK);
    ...
    if(result.error != static_cast<PredictionSLR::ErrorType>(PredictionError::PREDICTION_OK))
        return result.error;
...
PredictorSlrCPF::PredictionError PredictorSlrCPF::convertLagInterpError(stats::types::LagrangeError error)
{
    ...
    case stats::types::LagrangeError::NOT_ERROR :
        cpf_error = PredictionError::PREDICTION_OK; break;
